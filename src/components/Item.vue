<template>
  <li class="news-item">
    <span class="score">{{ item.score }} <br /> 
    ...
    <a :href="'https://twitter.com/intent/tweet?via=hackernewsj&text=' + item.title + '&url=' + item.url" target="_blank" class="twitter-share-button">Tweet</a>
    </span>
    <span class="title">
